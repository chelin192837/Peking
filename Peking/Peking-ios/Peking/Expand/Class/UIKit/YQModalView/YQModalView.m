...
#pragma mark - public
- (void)showBegin:(void(^)(void))beginBlock end:(void(^)(void))endBlock{
...
- (void)dismissEnd:(void(^)(void))endBlock{
    ...
    if (self.duration) {
        [UIView animateWithDuration:self.duration animations:^{
            ...
            // 调用代理方法
            if (self->_delegateFlag.didDismiss) {
