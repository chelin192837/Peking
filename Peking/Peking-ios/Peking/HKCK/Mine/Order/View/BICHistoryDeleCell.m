...
@implementation BICHistoryDeleCell
...
{
    NSString* cellId = @"BICHistoryDeleCell";
    BICHistoryDeleCell * cell = [tableView dequeueReusableCellWithIdentifier:cellId];
    if (!cell) {
