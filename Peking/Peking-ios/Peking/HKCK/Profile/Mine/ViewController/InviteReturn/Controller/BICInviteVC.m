...
@interface BICInviteVC ()<UITableViewDelegate,UITableViewDataSource>
...
{
    WEAK_SELF
    [[BICProfileService sharedInstance] analytiInvitationReturnList:request serverSuccessResultHandler:^(id response) {
...
{
    BICReturnHisCell *cell = [BICReturnHisCell exitWithTableView:tableView];
