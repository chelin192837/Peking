...
@interface BICInviteRecordVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BICInviteRecordVC
...
{
    WEAK_SELF
    [[BICProfileService sharedInstance] analytiInvitationInfo:request serverSuccessResultHandler:^(id response) {
...
{
    BICInviteHisCell *cell = [BICInviteHisCell exitWithTableView:tableView];
