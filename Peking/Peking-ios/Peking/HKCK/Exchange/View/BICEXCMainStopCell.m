//
//  BICEXCMainStopCell.m
//  BiconomeBICEXCMainStopCell
//
...
@implementation BICEXCMainStopCell
...
{
    NSString* cellId = @"BICEXCMainStopCell";
    BICEXCMainStopCell * cell = [tableView dequeueReusableCellWithIdentifier:cellId];
    if (!cell) {
...
//    }
    ...
    double precent = changeNum/totalNum;
