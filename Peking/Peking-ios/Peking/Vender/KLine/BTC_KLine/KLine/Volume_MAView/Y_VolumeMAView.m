...
//        _VolumeMA30Label.text = [NSString stringWithFormat:@"  MA30:%@",[CommonMethod calculateWithRoundingMode:NSRoundPlain roundingValue:(double)model.Volume_MA30.doubleValue afterPoint:model.coin]];
//    }else if(type==3002){
//        _VolumeMA7Label.text = [NSString stringWithFormat:@"  EMA7:%@",[CommonMethod calculateWithRoundingMode:NSRoundPlain roundingValue:(double)model.EMA7.doubleValue afterPoint:model.coin]];
//        _VolumeMA30Label.text = [NSString stringWithFormat:@"  EMA30:%@",[CommonMethod calculateWithRoundingMode:NSRoundPlain roundingValue:(double)model.EMA30.doubleValue afterPoint:model.coin]];
//    }else if(type==3003){
//        _VolumeMA7Label.text = [NSString stringWithFormat:@"  BOLL_MD:%@",[CommonMethod calculateWithRoundingMode:NSRoundPlain roundingValue:(double)model.BOLL_MD.doubleValue afterPoint:model.coin]];
//        _VolumeMA30Label.text = [NSString stringWithFormat:@"  BOLL_MB:%@",[CommonMethod calculateWithRoundingMode:NSRoundPlain roundingValue:(double)model.BOLL_MB.doubleValue afterPoint:model.coin]];
//    }
