...
-(void)maProfileWithModel:(NSInteger)type{
    ...
    [self.kLineMAView maProfileWithModel:model type:type];
}
...
- (void)setTargetLineStatus:(Y_StockChartTargetLineStatus)targetLineStatus
{
    ...
    [self maProfileWithModel:targetLineStatus];
}
...
//            self.verticalView.backgroundColor = RGB(241, 241, 241);
        ...
        if(!self.dateLabel){
            ...
            self.dateLabel.layer.borderColor = kBICGetHomeCellPriceColor.CGColor;
