...
- (Y_StockChartSegmentView *)segmentView
{
    if(!_segmentView)
    {
        ...
        scorllLine.backgroundColor = kBICWhiteColor;
...
//        _moreSegmentView.backgroundColor = RGB(21, 32, 54);
        _moreSegmentView.backgroundColor = kBICWhiteColor;
...
//        _indicatorSegmentView.layer.borderColor = RGB(24, 50, 102).CGColor;
        _indicatorSegmentView.backgroundColor = kBICWhiteColor;
...
- (void)event_segmentButtonClicked:(UIButton *)btn {
    ...
    [self.kLineView maProfileWithModel:index];
//    if(index==3005){
//
//    }else if(index==3006){
//
