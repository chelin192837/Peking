...
@property(nonatomic,strong)NSArray *urlImgArr;
@property(nonatomic,strong)UIView * sourceView; //点击图片的父容器View
@property(nonatomic,assign)CGRect sourceRect;  //点击的图片frame。->动画要用


@property(nonatomic,assign)BOOL hidenOption;// 是否需要隐藏下面的功能按钮SM
